...
namespace BookStore.Data.ViewModels
{
    public class ProductVM
    {
        ...
        [DataType(DataType.Currency)]
        [Display(Name = "Cijena nakon provizije")]
        public double PriceAfterProvision { get; set; }
        [Display(Name = "Slika")]
        ...
        [Display(Name = "Odaberite potkategoriju")]
        [Required(ErrorMessage = "Potrebno je odabrati potkategoriju")]
