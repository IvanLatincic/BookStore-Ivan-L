...
namespace BookStore.Data.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IGenericRepository<PaymentMethod> PaymentMethods => _paymentMethods ??= new GenericRepository<PaymentMethod>(_dbContext);
        public IGenericRepository<OrderItem> OrderItems => _orderItems ??= new GenericRepository<OrderItem>(_dbContext);
    }
}
